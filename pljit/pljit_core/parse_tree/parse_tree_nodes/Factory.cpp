...
std::pair<const Factory::SeparatorType, const TerminalSymbol> Factory::produceSeparator(lexer::Lexer& l) {
    ...
    switch (s->token_type) {
        case lexer::LexerToken::Error:
            throw pljit::Error(s->source_code_reference, pljit::Error::Lexer, static_cast<lexer::LexerErrorToken*>(s.get())->error_message);
        ...
        default:
            throw pljit::Error(s->source_code_reference, pljit::Error::ParseTree, "Expected separator");
    }
}
const TerminalSymbol Factory::produceDeclarator(lexer::Lexer& l) {
    ...
    switch (d->token_type) {
        case lexer::LexerToken::Error:
            throw pljit::Error(d->source_code_reference, pljit::Error::Lexer, static_cast<lexer::LexerErrorToken*>(d.get())->error_message);
        case lexer::LexerToken::Declarator: {
            return d->source_code_reference;
        }
        default:
            throw pljit::Error(d->source_code_reference, pljit::Error::ParseTree, "Expected declarator");
    }
}
const TerminalSymbol Factory::produceAssignment(lexer::Lexer& l) {
    ...
    switch (a->token_type) {
        case lexer::LexerToken::Error:
            throw pljit::Error(a->source_code_reference, pljit::Error::Lexer, static_cast<lexer::LexerErrorToken*>(a.get())->error_message);
        case lexer::LexerToken::Assignment: {
            return a->source_code_reference;
        }
        default:
            throw pljit::Error(a->source_code_reference, pljit::Error::ParseTree, "Expected assignment");
    }
}
